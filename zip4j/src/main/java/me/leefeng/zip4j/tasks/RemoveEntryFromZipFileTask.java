...
import static me.leefeng.zip4j.headers.HeaderUtil.getIndexOfFileHeader;
import static me.leefeng.zip4j.util.FileUtils.copyFile;

public class RemoveEntryFromZipFileTask extends AsyncZipTask<RemoveEntryFromZipFileTask.RemoveEntryFromZipFileTaskParameters>  {
