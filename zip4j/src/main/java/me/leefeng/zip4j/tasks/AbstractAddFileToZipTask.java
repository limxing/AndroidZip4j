...
import static me.leefeng.zip4j.headers.HeaderUtil.getFileHeader;
import static me.leefeng.zip4j.model.enums.CompressionMethod.DEFLATE;
import static me.leefeng.zip4j.model.enums.CompressionMethod.STORE;
import static me.leefeng.zip4j.model.enums.EncryptionMethod.NONE;
import static me.leefeng.zip4j.model.enums.EncryptionMethod.ZIP_STANDARD;
import static me.leefeng.zip4j.progress.ProgressMonitor.Task.ADD_ENTRY;
import static me.leefeng.zip4j.progress.ProgressMonitor.Task.CALCULATE_CRC;
import static me.leefeng.zip4j.progress.ProgressMonitor.Task.REMOVE_ENTRY;
import static me.leefeng.zip4j.util.CrcUtil.computeFileCrc;
import static me.leefeng.zip4j.util.FileUtils.getRelativeFileName;
import static me.leefeng.zip4j.util.InternalZipConstants.BUFF_SIZE;
import static me.leefeng.zip4j.util.Zip4jUtil.javaToDosTime;
